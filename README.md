...
### 🚀 About Me
- 🛠️ **Current Focus:** Backend API development (FastAPI/Node.js) and Data Visualization.
- 📊 **Passion:** Turning complex statistical data into actionable insights (ask me about the Labour Friction Index!).
- 🔋 **Projects:** Currently building a Battery Swap Network Simulation for West Delhi.
- ⚡ **Fun Fact:** I am an alien 👽 (or at least my code is out of this world).
